...
## [1.15.0](https://github.com/nrkno/tv-automation-playout-gateway/compare/v0.21.0...v1.15.0) (2021-08-18)


### Features

* add baseline expectedPlayoutItems support ([3bc02c1](https://github.com/nrkno/tv-automation-playout-gateway/commit/3bc02c18dccad7dda21420db441f8b1f3a670da5))
* add Caspar media retry interval to config manifest ([3dc47c3](https://github.com/nrkno/tv-automation-playout-gateway/commit/3dc47c391b420ac8ab5dd5aa109d5f615006f98a))
...
* Add clearMediaObjects event ([8cd0ced](https://github.com/nrkno/tv-automation-playout-gateway/commit/8cd0ced1e2e6a2754224ed6b5a690845e6b832c7))
...
* Add updateMediaObject event ([f7b3e1a](https://github.com/nrkno/tv-automation-playout-gateway/commit/f7b3e1a26a8042b2180a9fa5e543db1139ae57a3))
* Add viz engine rest port config ([785e9e0](https://github.com/nrkno/tv-automation-playout-gateway/commit/785e9e0dedeca5f4f3cf5ab8c161acddee8986e2))
...
* initial support for the upcoming expectedPlayoutItems feature in Core ([d06e8cc](https://github.com/nrkno/tv-automation-playout-gateway/commit/d06e8ccc907ed6b197ab168dbc12f3d7542ea192))
* make device aware of activeRundownPlaylistId ([1cd5d00](https://github.com/nrkno/tv-automation-playout-gateway/commit/1cd5d00beb8b1591753407e143c4165af2f63dc8))
...
* only push docker image if platform credentials are defined ([e60d05c](https://github.com/nrkno/tv-automation-playout-gateway/commit/e60d05cf019584ae71a768247357e9a2fa345dce))
...
* support activeRundownId in makeReady ([ae1197b](https://github.com/nrkno/tv-automation-playout-gateway/commit/ae1197b817278e9e7461127c1ba76a882d14e3d7))
...
* TSR dep ([e67b079](https://github.com/nrkno/tv-automation-playout-gateway/commit/e67b079c664fc674b2ecc168c13966a35ac60942))
* TSR dep ([15797b9](https://github.com/nrkno/tv-automation-playout-gateway/commit/15797b92b0d2060c343bd186f93f6030efe8b1fe))
* TSR dep which enables partial timeline resolving ([221bfe2](https://github.com/nrkno/tv-automation-playout-gateway/commit/221bfe26e577916666cd2533882366cc7c2df545))
...
* TSR: VizMSE: Clear commands ([e5f2064](https://github.com/nrkno/tv-automation-playout-gateway/commit/e5f2064a8085d498a3d0877b8852e1f1b7dcf456))
...
* be sure to send the executeFunction reply from the same device that received the command ([bfa66bd](https://github.com/nrkno/tv-automation-playout-gateway/commit/bfa66bdcdfef44e70947e55c370f4857169eecfd))
...
* bug fix: device wasn't created if device.options was undefined ([c3c3daa](https://github.com/nrkno/tv-automation-playout-gateway/commit/c3c3daaab8a94f935a6ed1b429492d867c48aa58))
...
* CircleCI ([f2cd149](https://github.com/nrkno/tv-automation-playout-gateway/commit/f2cd14967b6d3dd2c5fe94dba8735b4342798c9e))
* Circleci config ([80d9407](https://github.com/nrkno/tv-automation-playout-gateway/commit/80d9407b77ec0e438265fb13e2d55752cbd8be98))
...
* config property name ([fa357e4](https://github.com/nrkno/tv-automation-playout-gateway/commit/fa357e47f4a8839d97a14bbbd40e993090312b83))
* copy playlist id to Playout Item ([d96d598](https://github.com/nrkno/tv-automation-playout-gateway/commit/d96d598da99db2133e8a4571364d07b33d7d22af))
...
* enable executeFunction to execute functions directly on sub-devices as well as on main device ([7eb745a](https://github.com/nrkno/tv-automation-playout-gateway/commit/7eb745a0bcb92f63074c6b397f9766fa91dc5aaf))
* Failing to build ([fec0d0a](https://github.com/nrkno/tv-automation-playout-gateway/commit/fec0d0a409307cdbfa97366ca8b19f05d9dda0b3))
...
* improved gitactions pipeline ([f531f50](https://github.com/nrkno/tv-automation-playout-gateway/commit/f531f505a17d3ad0ddd8833bcf8ffcb7581af425))
...
* Make the ATEM commands hack work ([3ad7fea](https://github.com/nrkno/tv-automation-playout-gateway/commit/3ad7fea9fcf2f69c091105258b8dbdf2de7a439d))
...
* missing type assertion ([76f57c7](https://github.com/nrkno/tv-automation-playout-gateway/commit/76f57c796d9b48f14c8be4304ecad36fa3e81f17))
* partial revert, fcn in executeFunction needs to be run in the right context ([0d45026](https://github.com/nrkno/tv-automation-playout-gateway/commit/0d45026c67bedf38abac9475f59739ff0865db62))
* simple release process ([f140f7d](https://github.com/nrkno/tv-automation-playout-gateway/commit/f140f7d6be02795bb2cebd6d23291e3b01dd33ec))
* skip validate:dependencies ([24ea948](https://github.com/nrkno/tv-automation-playout-gateway/commit/24ea94823d403e81896227cc8141708e512f08bc))
...
* tsr dep ([4fae1dd](https://github.com/nrkno/tv-automation-playout-gateway/commit/4fae1dd9a00cbc39c5a856b54b76319ba217f6ee))
* TSR dep ([c8b7cb1](https://github.com/nrkno/tv-automation-playout-gateway/commit/c8b7cb12f4c64a2cfa46685258e9d64f6c4fb6f8))
* TSR dep ([ea12486](https://github.com/nrkno/tv-automation-playout-gateway/commit/ea12486c0413a1fa861bceaa9106772bcd1fe9ae))
* TSR dep ([efa8041](https://github.com/nrkno/tv-automation-playout-gateway/commit/efa804133efb754620914e6d96740541b40c122c))
* TSR dep ([029a6b4](https://github.com/nrkno/tv-automation-playout-gateway/commit/029a6b4517f3f72cd845ef9471d332d72b9c1f3f))
* TSR dep ([59343c8](https://github.com/nrkno/tv-automation-playout-gateway/commit/59343c83fc970f932a1086827f0b71dc97b0c9b3))
* TSR dep ([7c7e39c](https://github.com/nrkno/tv-automation-playout-gateway/commit/7c7e39c8276deb8e96c4020e46745b3e41d3a47e))
* TSR dep ([c979b6c](https://github.com/nrkno/tv-automation-playout-gateway/commit/c979b6c907279bbbe9a95ee66d18f24c1d1a48e4))
* TSR dep ([83ba768](https://github.com/nrkno/tv-automation-playout-gateway/commit/83ba768e5d6d375b372c18ed2aad8c9af387cbad))
* TSR dep ([7114a2c](https://github.com/nrkno/tv-automation-playout-gateway/commit/7114a2c482d96a3dd3dcce07e27a2c3045fed424))
* TSR dep ([9ec7573](https://github.com/nrkno/tv-automation-playout-gateway/commit/9ec757392cb2d210d261b248859b7343b03d790a))
* TSR dep ([ddfdc19](https://github.com/nrkno/tv-automation-playout-gateway/commit/ddfdc1919c86306f013727364988d74f9bd79434))
* TSR dep ([41d11c0](https://github.com/nrkno/tv-automation-playout-gateway/commit/41d11c0d7bd7d195b3f6d43607a4638372fd7e19))
* TSR dep ([c2233da](https://github.com/nrkno/tv-automation-playout-gateway/commit/c2233da674cbe6aac6e7ae957a51a8c713a9785e))
* TSR dep ([c30fe4e](https://github.com/nrkno/tv-automation-playout-gateway/commit/c30fe4e58a7ccaaa909fadcbb2be05b43a611547))
* TSR dep ([1f73362](https://github.com/nrkno/tv-automation-playout-gateway/commit/1f733620f818ffe75129366c07c7a79075117047))
* TSR dep ([5c8b6cb](https://github.com/nrkno/tv-automation-playout-gateway/commit/5c8b6cb639448663a5214d7c9a43045977e11ae2))
* TSR dep ([c74e19e](https://github.com/nrkno/tv-automation-playout-gateway/commit/c74e19edd4ac93ae0f44788f84a214bdbefbd800))
* TSR dep ([4426f4b](https://github.com/nrkno/tv-automation-playout-gateway/commit/4426f4bf22b6d8df56a689a0b6bc506a26a7978e))
* TSR dep ([a9f0630](https://github.com/nrkno/tv-automation-playout-gateway/commit/a9f0630e0e60fa3df0d0edf233cf9f726df987e7))
* TSR dep update ([0fac9ff](https://github.com/nrkno/tv-automation-playout-gateway/commit/0fac9ff3326391e30584bb15c84b9923d0a8476e))
...
* TSR programInput property ([56e3d3f](https://github.com/nrkno/tv-automation-playout-gateway/commit/56e3d3f51cd9d9bcfecf5af4ad3b829016f0d596))
* TSR: Caspar retry timer ([d56ef75](https://github.com/nrkno/tv-automation-playout-gateway/commit/d56ef75861473f5f19e396c468387e446bd8c8be))
* TSR: exclude timelineOjbId and transition from diff (VizMSE) ([cdebe3b](https://github.com/nrkno/tv-automation-playout-gateway/commit/cdebe3b0801e07f28394e13df08847a19acc0dca))
* TSR: Sisyfos resync ([1eea86b](https://github.com/nrkno/tv-automation-playout-gateway/commit/1eea86bf3e27513c3a110f85c21dfe52802be250))
* TSR: v-connection version and retry logic ([4277615](https://github.com/nrkno/tv-automation-playout-gateway/commit/4277615fee191f814449cc8b28240ef848afc69f))
* TSR: Viz channel for internal elements ([3da3410](https://github.com/nrkno/tv-automation-playout-gateway/commit/3da34100b895487481831020e198ed44fc404eeb))
* TSR: Viz: MSE status ([6ada699](https://github.com/nrkno/tv-automation-playout-gateway/commit/6ada699b24a9a2ad8805cda09569e969d6003f7f))
* TSR: VizMSE: Retry to initialize the rundown ([7be0169](https://github.com/nrkno/tv-automation-playout-gateway/commit/7be0169878b84dd51ddf06deba7122d9dcb8dc26))
...
* Validate dependencies for tags ([f07a90a](https://github.com/nrkno/tv-automation-playout-gateway/commit/f07a90ae58ea60f5ff164dc230338c233a6fe2c2))
* vulnerable deps ([a8071e2](https://github.com/nrkno/tv-automation-playout-gateway/commit/a8071e2a0d7eb58ddada947409fd81a3a01f2b0e))
...
* add _triggerupdateExpectedPlayoutItems at a point where TSRHandler is initialized ([af5b2a4](https://github.com/nrkno/tv-automation-playout-gateway/commit/af5b2a496ccdc3d50aadfe6d2b48212a225054c9))
* add call to onConnected, to ensure observers are set up before subscriptions ([d70b4cf](https://github.com/nrkno/tv-automation-playout-gateway/commit/d70b4cf4eedd2447b0b3c4984586fbe6c0c0b9de))
...
* circleci ([974f9d5](https://github.com/nrkno/tv-automation-playout-gateway/commit/974f9d5133f92ba04dfbae59d4aeb86036df9389))
...
* DeviceOptionsAny ([c095206](https://github.com/nrkno/tv-automation-playout-gateway/commit/c095206245b38bc31a33f03d4ab30e9f3058be6b))
...
* hail Mary ([6e8a00e](https://github.com/nrkno/tv-automation-playout-gateway/commit/6e8a00e87d6c5c419f46841b04c83fb6f807612e))
...
* move _triggerupdateExpectedPlayoutItems to after a device has been created ([2700270](https://github.com/nrkno/tv-automation-playout-gateway/commit/270027055bc77156734335676b78c99402ca70b2))
...
* possible fix for issue with subscription/observing expectedPlayoutItems ([fda74fe](https://github.com/nrkno/tv-automation-playout-gateway/commit/fda74feb7d4fb679232f7a01c8e316d684cff9ad))
...
* rundownId on expectedPlayoutItems ([aba8179](https://github.com/nrkno/tv-automation-playout-gateway/commit/aba81790f12f8503c8413f1ff6e3db736fc4b064))
...
* TSR dep ([5efe23d](https://github.com/nrkno/tv-automation-playout-gateway/commit/5efe23ded96ee9bed2566cabd3c8f0518138f59a))
* TSR dep ([926eb06](https://github.com/nrkno/tv-automation-playout-gateway/commit/926eb06a364b8afffafa2b1ca1dc837bf7e563cc))
* TSR dep ([2008ddf](https://github.com/nrkno/tv-automation-playout-gateway/commit/2008ddf1996e805994c3e4f9624c97453f96f82b))
* TSR dep ([66b80d2](https://github.com/nrkno/tv-automation-playout-gateway/commit/66b80d2c3dc0dff92b69fafed75ed350b3591950))
* TSR dep ([502d5dc](https://github.com/nrkno/tv-automation-playout-gateway/commit/502d5dc68b708b88a270a82e95e6572e85cb7ec8))
* TSR dep ([423b057](https://github.com/nrkno/tv-automation-playout-gateway/commit/423b057511caa4d08ca77199d510fbd36c8c2930))
...
* TSR dep, fixing issue with stoppedPlayback ([74c3a10](https://github.com/nrkno/tv-automation-playout-gateway/commit/74c3a109f3a12ebd24dabc2425c26b48149af9c9))
...
* TSR update ([802e9c7](https://github.com/nrkno/tv-automation-playout-gateway/commit/802e9c714d28276cc41c5b3566e93e9b4201b1a3))
...
* update TSR ([148ba7c](https://github.com/nrkno/tv-automation-playout-gateway/commit/148ba7cdcefe51c36a6368e6112d22abacf1849e))
* update TSR ([b61ac88](https://github.com/nrkno/tv-automation-playout-gateway/commit/b61ac889f61f546c54e43ae0726f19848f506bf0))
* update TSR ([a3f8152](https://github.com/nrkno/tv-automation-playout-gateway/commit/a3f81525b8212f18c3bacdd47fbf1f4fe8621388))
* update TSR ([d410cee](https://github.com/nrkno/tv-automation-playout-gateway/commit/d410cee70db5718308371440493f706635af1742))
* update TSR ([f502acb](https://github.com/nrkno/tv-automation-playout-gateway/commit/f502acbb4c9c3c27b0d76a0638e9649b83347aa4))
* update TSR (temp hack) ([cfee2aa](https://github.com/nrkno/tv-automation-playout-gateway/commit/cfee2aa68ea76dbe4b6db632570ade4236771492))
...
* update TSR dep ([d5a03cf](https://github.com/nrkno/tv-automation-playout-gateway/commit/d5a03cf6b76d8767892e342ee7be8caba5747e1e))
* update TSR dep ([7f6acba](https://github.com/nrkno/tv-automation-playout-gateway/commit/7f6acbacf3f458588eb765ba4a40bab33f2a2e63))
...
* update TSR dep ([0a6fc68](https://github.com/nrkno/tv-automation-playout-gateway/commit/0a6fc68205def0f0ff164d23bea699d44fb8079e))
* update TSR dep ([f5c4d7f](https://github.com/nrkno/tv-automation-playout-gateway/commit/f5c4d7fbaedab585828991bfa45846c2eaae4090))
* update TSR dep ([0d1a5b5](https://github.com/nrkno/tv-automation-playout-gateway/commit/0d1a5b549e33dc033c03de5b582735d529fd63d0))
...
* update typescript version, as TSR has had its version updated ([28df551](https://github.com/nrkno/tv-automation-playout-gateway/commit/28df551c15dde33885d6462e10772fd23c408129))
